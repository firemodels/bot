...
if NOT "%platform%" == "Linux" goto endif2
  ...
  plink -no-antispoof %linux_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle_custom.sh .bundle/bundles %smv_revision%_lnx.sh              %linux_git_root%/bot/Bundlebot/nightly %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
  plink -no-antispoof %linux_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle_custom.sh .bundle/bundles %smv_revision%_lnx_manifest.html   %linux_git_root%/bot/Bundlebot/nightly %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
:endif2
...
if NOT "%platform%" == "OSX" goto endif3
  ...
  plink -no-antispoof %osx_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle_custom.sh .bundle/bundles %smv_revision%_osx.sh              %linux_git_root%/bot/Bundlebot %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
  plink -no-antispoof %osx_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle_custom.sh .bundle/bundles %smv_revision%_osx_manifest.html   %linux_git_root%/bot/Bundlebot %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
:endif3
