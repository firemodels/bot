...
echo "-c - use apps and pubs previously copied from firebot and smokebot"
echo "     to $HOME/.bundle/apps and $HOME/.bundle/pubs directories"
...
while getopts 'a:A:b:cd:fF:ghp:S:uUvVw' OPTION
do
case $OPTION  in
  a)
   app_host=$OPTARG
