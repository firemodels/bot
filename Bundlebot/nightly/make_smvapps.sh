...
BUILDSMVLIBS()
{
  cd $smvrepo/Build/LIBS/${BUNDLE_SMVCOMPILER}_$platform
...
BUILD()
{
  ...
  cd $smvrepo/Build/$prog/${BUNDLE_SMVCOMPILER}_$platform
...
CHECK_BUILD()
{
  ...
  if [ ! -e $smvrepo/Build/$prog/${BUNDLE_SMVCOMPILER}_$platform/${prog}_$platform$DEBUG ]; then
    ...
    cp $smvrepo/Build/$prog/${BUNDLE_SMVCOMPILER}_$platform/${prog}_$platform$DEBUG $CURDIR/apps/$prog
  fi
}
