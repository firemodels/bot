...
if NOT "%platform%" == "Linux" goto endif2
  ...
  plink %plink_options% %linux_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle.sh .bundle/uploads %smv_revision%_lnx.sh   %linux_git_root%/bot/Bundlebot/nightly %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
  plink %plink_options% %linux_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle.sh .bundle/uploads %smv_revision%_lnx.sha1 %linux_git_root%/bot/Bundlebot/nightly %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
:endif2
...
if NOT "%platform%" == "OSX" goto endif3
  ...
  plink %plink_options% %osx_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle.sh .bundle/uploads %smv_revision%_osx.sh   %linux_git_root%/bot/Bundlebot %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
  plink %plink_options% %osx_logon%  %linux_git_root%/bot/Bundlebot/nightly/upload_smvbundle.sh .bundle/uploads %smv_revision%_osx.sha1 %linux_git_root%/bot/Bundlebot %SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
:endif3
