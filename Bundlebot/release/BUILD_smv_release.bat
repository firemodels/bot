...
gh release upload %GH_SMV_TAG% %fullfilebase%.sha1 -R github.com/%GH_SMOKEVIEW_OWNER%/%GH_REPO% --clobber

echo uploading %fullfilebase%.exe
gh release upload %GH_SMV_TAG% %fullfilebase%.exe  -R github.com/%GH_SMOKEVIEW_OWNER%/%GH_REPO% --clobber
