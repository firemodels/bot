...
DOWNLOADFILE  $APPOWNER ${BUNDLE_BASE}lnx_manifest.html

DOWNLOADFILE  $APPOWNER ${BUNDLE_BASE}osx.sh
DOWNLOADFILE $APPOWNER ${BUNDLE_BASE}osx_manifest.html

DOWNLOADFILE  $APPOWNER ${BUNDLE_BASE}win.exe
DOWNLOADFILE $APPOWNER ${BUNDLE_BASE}win_manifest.html
