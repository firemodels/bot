...
4. The `BUILD_bundle.sh` and `BUILD_bundle.bat` scripts upload bundles to https://github.com/firemodels/test_bundles/releases/tag/BUNDLE_TEST
5. The scripts `GH2bundles.sh` (Linux and Mac) and `GHbundles.bat` (Windows PC) download the bundles to the bundles directory where they can then used to create an official release.
