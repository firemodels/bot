...
echo.
echo Linux
plink %plink_options% %linux_logon% %scriptdir%/setbranch_master.sh  %linux_svn_root%/fds
echo.

echo OSX
plink %plink_options% %osx_logon% %scriptdir%/setbranch_master.sh  %linux_svn_root%/fds
