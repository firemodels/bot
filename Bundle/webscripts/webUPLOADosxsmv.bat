...
plink %plink_options% %linux_logon%  %linux_svn_root%/bot/Bundlebot/upload_smvbundle.sh .bundle/uploads %smv_revision%_osx.sh   %linux_svn_root%/bot/Bundlebot %GH_SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
plink %plink_options% %linux_logon%  %linux_svn_root%/bot/Bundlebot/upload_smvbundle.sh .bundle/uploads %smv_revision%_osx.sha1 %linux_svn_root%/bot/Bundlebot %GH_SMOKEVIEW_TAG% %GH_OWNER% %GH_REPO%
