...
function usage {
echo "This script builds a bundle using applications built by firebot, FDS pubs built by firebot,"
...
echo "   firebot/smokebot on the computer running this script."
...
echo ""
echo "Options:"
echo " parameters specifying app host and home directory"
echo "-a - host containing apps [default: $app_host]"
echo "-F - home directory containing apps [default: $app_home]"
echo ""
echo " parameters specifying pub host and home directories"
...
echo ""
echo "parameters specifying branches used to build bundle"
echo "-b branch_name - use branch named branch_name to make bundle [default: $BRANCH]"
...
echo "-d - directory containing bundle generated by this script [default: $bundle_dir]"
