...
Jason Floyd \\
JENSEN HUGHES, Rockville, Maryland \\
\end{flushright}
}
...
{\em Walter Copan, Undersecretary of Commerce for Standards and Technology, and Director}
\end{flushright}
}
...
Natl.~Inst.~Stand.~Technol.~Tech.~Note.~#1, \pageref{LastPage} pages (April~2018) \\
CODEN: NSPUE2 }
...
{
\item[Glenn Forney] is a computer scientist at the Engineering Laboratory of NIST.  He received a bachelor of science degree in mathematics from Salisbury State College and a master of science and a doctorate in mathematics from Clemson University.  He joined NIST
in 1986 (then the National Bureau of Standards) and has since worked on developing tools that
provide a better understanding of fire phenomena, most notably Smokeview, a software tool for visualizing Fire Dynamics Simulator data.
}
