...
# compare images generated by this smokebot run with a base set in the fig repo
       TOLERANCE=0.2
       cd $botrepo/Smokebot
       ../Firebot/compare_images.sh $figrepo/smv/Reference_Figures $SMV_SUMMARY_DIR/images $SMV_SUMMARY_DIR/diffs/images $OUPUT_DIR/error_images $TOLERANCE >& $OUTPUT_DIR/stage5_image_compare
