...
# compare images generated by this smokebot run with a base set in the fig repo
       cd $botrepo/Smokebot
       ../Firebot/compare_images.sh $figrepo/compare/smokebot/images $SMV_SUMMARY_DIR/images $SMV_SUMMARY_DIR/diffs/images $OUPUT_DIR/error_images >& $OUTPUT_DIR/stage5_image_compare
