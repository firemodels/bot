...
run_verification_cases_debug()
{
   ...
   ./Run_SMV_Cases.sh $INTEL2 -Y $OLDFDSDIR -c $cfastrepo $USEINSTALL2 -j $JOBPREFIX -m 2 -d -q $SMOKEBOT_QUEUE >> $OUTPUT_DIR/stage3a 2>&1
}
...
run_verification_cases_release()
{
   ...
   ./Run_SMV_Cases.sh $INTEL2 -Y -c $cfastrepo $OLDFDSDIR -j $JOBPREFIX $USEINSTALL2 $RUN_OPENMP -q $SMOKEBOT_QUEUE >> $OUTPUT_DIR/stage3b 2>&1
}
