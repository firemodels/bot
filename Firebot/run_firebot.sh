...
echo "./run_firebot.sh -C - Clones repos with branch name master before running firebot"
echo "                      This option should NEVER be run in the repos where"
echo "                      you do your regular work. Repos that are cloned are erased first."
echo "./run_firebot.sh -R nightly - Clones repos with branch name nightly before running firebot"
echo "Options:"
